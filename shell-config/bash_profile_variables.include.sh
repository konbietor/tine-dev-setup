### Base directories ###
DEV_SOFTWARE_HOME=/cygdrive/c/Dev-Software-Tine
DEV_HOME=/cygdrive/c/Users/THB-Tine/Dev
GIT_REPOSITORIES_HOME=$DEV_HOME/git-repos
...
export JREBEL_HOME=C:\\Dev-Software-Tine\\JRebel\\jrebel-5.1.2

### Windows special modification ###
# (Remove this if Linux/Mac)
